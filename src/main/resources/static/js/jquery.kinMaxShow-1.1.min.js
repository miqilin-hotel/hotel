	...
	$("#kinMaxShow").kinMaxShow({
			...
			button:{
			    ...
			    //【友情提示：可以设置透明度哦 不用区分浏览器 统一为 opacity，CSS3属性也支持哦 如：设置按钮圆角、投影等，只不过IE8及以下不支持】            
                            normal:{background:'url(http://www.loristarhotel.cn/images/button.png) no-repeat -14px 0',marginRight:'8px',border:'0',left:'45%',bottom:'20px'},
                            //当前焦点图按钮样式 设置，写法同上
                            focus:{background:'url(http://www.loristarhotel.cn/images/button.png) no-repeat 0 0',border:'0'}
			},
